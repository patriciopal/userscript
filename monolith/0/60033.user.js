...
var vers_ist = 'DS - Unterst\xfctzter Spieler 1.0.8';
// Aktueller Dateipfad:
...
if (url.match(/article=units/)) {
  // Testinfo erweitern:
  testinfo += 'Einheiten\xfcbersicht:\n\n';
  ...
  if (url.match(/screen=settings&mode=settings/)) {
    ...
    if (url.match(/einstellung=unterstuetzungen/)) {
      ...
      if (confirm('Kartenmarkierungen:\n\nSollen die unterst\xfctzten D\xf6rfer in der Karte markiert werden?')) {
      ...
      GM_setValue('Y-Startwert-' + welt, prompt('Y-Startwert:\n\nHier kannst Du den Y-Startwert f\xfcr die Tooltips anpassen', Startwert));
    }
    var tr = [];
    ...
    if (GM_getValue('Neuname-' + welt) == undefined || GM_getValue('Letzte-Supp-' + welt) == undefined || GM_getValue('Letzte-Deff-' + welt) == undefined || GM_getValue('Verlustanzeige-' + welt) == undefined || GM_getValue('Kampfwerte-' + welt) == undefined || GM_getValue('Y-Startwert-' + welt) == undefined) {
      ...
      td[0].innerHTML = '<a href=\'http://' + land + welt + adresse[land] + land + '/game.php?village=' + akt_dorf_id + '&screen=settings&mode=settings&einstellung=unterstuetzungen\'>Einstellungen \xe4ndern</a>';
      ...
      td[1].innerHTML += '<b style=\'padding-right:4px;\'>Dorfname neu:</b>' + neuname.replace('an', '<span style=\'color:#090\'>an</span> <span class=\'grey\'>(Es wird angezeigt wenn sich der Dorfname ge\xe4ndert hat)</span>').replace('aus', '<span style=\'color:#C00\'>aus</span> <span class=\'grey\'>(Es wird nicht angezeigt wenn sich der Dorfname ge\xe4ndert hat)</span>') + '<br>';
      ...
      td[1].innerHTML += '<b style=\'padding-right:19px;\'>Letzte Supp:</b>' + letzt_s.replace('an', '<span style=\'color:#090\'>an</span> <span class=\'grey\'>(Es wird angezeigt wann Du das  Dorf das letzte mal unterst\xfctzt hast.)</span>').replace('aus', '<span style=\'color:#C00\'>aus</span> <span class=\'grey\'>(Letzte Unterst\xfctzung wird nicht angezeigt.)</span>') + '<br>';
      td[1].innerHTML += '<b style=\'padding-right:24px;\'>Letzte Deff:</b>' + letzt_d.replace('an', '<span style=\'color:#090\'>an</span> <span class=\'grey\'>(Es wird angezeigt wann die Unterst\xfctzung das letzte mal angegriffen wurde)</span>').replace('aus', '<span style=\'color:#C00\'>aus</span> <span class=\'grey\'>(Keine Anzeige der letzten Verteidigung)</span>') + '<br>';
      ...
      td[1].innerHTML += '<b style=\'padding-right:61px;\'>Karte:</b>' + marker.replace('an', '<span style=\'color:#090\'>an</span> <span class=\'grey\'>(Die unterst\xfctzten D\xf6rfer werden auf der Karte markiert)</span>').replace('aus', '<span style=\'color:#C00\'>aus</span> <span class=\'grey\'>(Unterst\xfctzten D\xf6rfer werden nicht markiert)</span>') + '<br>';
    ...
    if (url.match(/screen=/) && (GM_getValue('Neuname-' + welt) == undefined || GM_getValue('Entfernungen-' + welt) == undefined || GM_getValue('Letzte-Supp-' + welt) == undefined || GM_getValue('Letzte-Deff-' + welt) == undefined || GM_getValue('Verlustanzeige-' + welt) == undefined || GM_getValue('Kartenmarkierungen-' + welt) == undefined || GM_getValue('Kampfwerte-' + welt) == undefined || GM_getValue('Y-Startwert-' + welt) == undefined)) {
      if (confirm(vers_ist + ' ist jetzt installiert\n\nKlicke auf OK um die Einstellungen f\xfcr die Anzeige der Mitgliederliste vorzunehmen')) {
  ...
  if (url.match(/view=/)) {
    ...
    if (betreff.indexOf('unterst\xfctzt') > -1) {
      // Bericht-ID:
  ...
  if (url.match(/screen=place&mode=command/)) {
    ...
    if (GM_getValue('Koordinatenliste-' + akt_dorf_id) != undefined && GM_getValue('Koordinatenliste-' + akt_dorf_id) != '') {
      // Links zählen:
      links = document.getElementById('units_form').getElementsByTagName('a').length - 1;
      // Letzten Link verändern:
      document.getElementById('units_form').getElementsByTagName('a')[links].innerHTML += ' &<br />Unterst\xfctzte';
    }
    // Deffliste:
    var deffliste = '';
    ...
    deffliste += '<tbody>';
    deffliste += '<tr>';
    deffliste += '<td class=\'selected\'><b style=\'color:#804000;\'>Unterst\xfctzte D\xf6rfer</b></td>';
    deffliste += '</tr>';
    deffliste += '</tbody>';
    deffliste += '</table>';
    deffliste += '<table class=\'vis\'>';
  ...
  if (url.match(/screen=place&mode=units/)) {
    var wertzelle = '';
    wertzelle += '<tr><td><a href=\'http://' + land + welt + adresse[land] + land + '/help2.php?article=units\' target=\'_blank\' title=\'Die Werte f\xfcr Welt ' + welt + ' einlesen und speichern.\'>Werte</a> ';
    if (GM_getValue('Werte-W-' + welt) == undefined) {
      var punkte_einlesen = '<a href=\'http://' + land + welt + adresse[land] + land + '/help2.php?article=units\' target=\'_blank\' style=\'margin-left:10px; color:#C00;\' title=\'Punkte f\xfcr Welt ' + welt + ' auslesen und speichern\'>Pkt. einlesen</a> ';
      wertzelle += '<b style=\'color:#C00; text-decoration:blink; cursor:help;\' title=\'Die Werte f\xfcr Welt ' + welt + ' wurden noch nicht gespeichert.\'>!!!</b></td></tr>';
    } else {
      var punkte_einlesen = '<a href=\'http://' + land + welt + adresse[land] + land + '/help2.php?article=units\' target=\'_blank\' style=\'margin-left:10px; color:#090;\' title=\'Punkte f\xfcr Welt ' + welt + ' wurden bereits gespeichert\'>Pkt. OK</a> ';
      wertzelle += '<b style=\'color:#090; cursor:help;\' title=\'Die Werte f\xfcr Welt ' + welt + ' wurden bereits gespeichert.\'>OK</b></td></tr>';
    }
    ...
    var info = '<table>';
    info += '<th style=\'-moz-border-radius-topleft:10px;\'><img src=\'http://www.die-staemme.de/graphic/command/support.png\' style=\'padding:2px;\' title=\'Anzahl der unterst\xfctzten D\xf6rfer\'></th>';
    info += '<th>Dorf</th>';
    ...
    if (vis >= 2) {
        ...
        if (i == 1) {
          ...
          if (secure_name != undefined) {
            if (supp_dorf_name == secure_name) {
              var rename_check = 'Dorfnamen stimmen noch \xfcberein';
              var rename_status = LED_gruen;
            } else {
              var rename_check = 'Achtung! Dorfname wurde ge\xe4ndert.';
            ...
            if (GM_getValue('W' + welt + '-Mitglieder') != undefined) {
              ...
              if (GM_getValue('W' + welt + '-Mitglieder').indexOf(supp_spieler_name) > -1) {
                ...
                if (barbar == 1) {
                  ...
                  if (GM_getValue('W' + welt + '-Stamm-Typ-' + supp_stamm_id) == 'Verb\xfcndete') {
                    var stamm = '<a href=\'' + pfad_stamm + '&id=' + supp_stamm_id + '\'><img src=\'' + icon_stamm_bnd + '\' title=\'BND - verb\xfcndeter Stamm: &bdquo;' + supp_stamm_name + '&rdquo;\' style=\'height:12px;\'>';
      ...
      if (GM_getValue('Kampfwerte-' + welt) == 'an') {
        ...
        if (GM_getValue('Werte-W-' + welt) == undefined) {
          tabelle.innerHTML += '<tr><th colspan=\'' + (spalten + 1) + '\'><b style=\'color:#C00; text-decoration:blink;\'>Punkte f\xfcr Welt ' + welt + ' wurden noch nicht gespeichert!</b><a href=\'http://' + land + welt + adresse[land] + land + '/help2.php?article=units\' target=\'_blank\' style=\'margin-left:10px;\' title=\'Punkte f\xfcr Welt ' + welt + ' auslesen und speichern\'>Jetzt speichern</a></th></tr>';
        }  // if-ENDE
        else {
          ...
          for (x = 2; x < spalten; x++) {
            ...
            if (x == 2) {
              zeile_werte += '<td></td><td style=\'padding:0px; text-align:center;\'><img src=\'' + icon_deff_b + '\' style=\'height:14px;\'></td><td>Deff-B\xf6gen</td>';
            }
    ...
    if (vis == 3) {
      ...
      if (GM_getValue('Letzte-Supp-' + welt) == 'an') {
        neu_th += '</th><th style=\'text-align:center; -moz-border-radius-topleft:10px; -moz-border-radius-topright:10px;\' title=\'Datum der letzten Unterst\xfctzung\'><img src=\'' + icon_support + '\'>';
      }
      if (GM_getValue('Letzte-Deff-' + welt) == 'an') {
      ...
      for (var i = 1; i < zeilen; i++) {
        ...
        if (GM_getValue('Letzte-Supp-' + welt) == 'an') {
          ...
          if (letzter_bericht != undefined) {
            ...
            var bericht_datum_titel = 'Datum der letzten Unterst\xfctzung: ' + letzter_bericht;
          } else {
            var bericht_datum = '??.??.??';
            var bericht_datum_titel = 'Das Datum der letzten Unterst\xfctzung wurde bisher noch nicht gespeichert.';
          }
        }
        // Letzter Angriff:
        if (GM_getValue('Letzte-Deff-' + welt) == 'an') {
          ...
          if (letzter_angriff != undefined) {
            ...
            var angriff_datum_titel = 'Deine Unterst\xfctzung in &bdquo;' + supp_dorf_name + '&rdquo; wurde bisher noch nicht angegriffen bzw. es wurde bisher noch keine Informationen gespeichert.';
          }
        }
        // Verluste:
        if (GM_getValue('Verlustanzeige-' + welt) == 'an') {
        ...
        if (supp_spieler_name != undefined) {
          ...
          if (GM_getValue('W' + welt + '-Mitglieder') != undefined) {
            ...
            if (GM_getValue('W' + welt + '-Mitglieder').indexOf(supp_spieler_name) > -1) {
              ...
              if (barbar == 1) {
                ...
                if (GM_getValue('W' + welt + '-Stamm-Typ-' + supp_stamm_id) == 'Verb\xfcndete') {
                  var stamm = '<a href=\'' + pfad_stamm + '&id=' + supp_stamm_id + '\'><img src=\'' + icon_stamm_bnd + '\' title=\'BND - verb\xfcndeter Stamm: &bdquo;' + supp_stamm_name + '&rdquo;\' style=\'height:12px;\'></a>';
                } else if (GM_getValue('W' + welt + '-Stamm-Typ-' + supp_stamm_id) == 'Nicht-Angriffs-Pakt (NAP)') {
                  var stamm = '<a href=\'' + pfad_stamm + '&id=' + supp_stamm_id + '\'><img src=\'' + icon_stamm_nap + '\' title=\'NAP - Nicht-Angriffs-Pakt: &bdquo;' + supp_stamm_name + '&rdquo;\' style=\'height:12px;\'></a>';
                } else if (GM_getValue('W' + welt + '-Stamm-Typ-' + supp_stamm_id) == 'Feinde') {
                  var stamm = '<a href=\'' + pfad_stamm + '&id=' + supp_stamm_id + '\'><img src=\'' + icon_stamm_feind + '\' title=\'Feind! - feindlicher Stamm: &bdquo;' + supp_stamm_name + '&rdquo;\' style=\'height:12px;\'></a>';
          ...
          if (GM_getValue('Letzte-Supp-' + welt) == 'an') {
            info += '<td style=\'text-align:right; background-color:#F7EED3;\' title=\'Datum der letzten Unterst\xfctzung\'><small>' + bericht_datum + '</small></td>';
          }
          if (GM_getValue('Letzte-Deff-' + welt) == 'an') {
          ...
          zeile.innerHTML = zeile.innerHTML.replace(/<\/a>/, '</a></td><td colspan=\'2\' style=\'background-color:#F7EED3;\'><a href=\'http://' + land + welt + adresse[land] + land + '/game.php?village=' + akt_dorf_id + '&screen=report&mode=support\' target=\'Berichte\' title=\'Der unterst\xfctzte Spieler wurde noch nicht eingelesen.\' style=\'color:#C00\'>unbekannt</a>' + neu_td_n);
          // Infotabelle erweitern:
          info += '<tr>';
          info += '<td style=\'text-align:right; background-color:#F7EED3;\'>' + i + '.</td>';
        ...
        testinfo += '--------------------------------------------------';
        testinfo += '\n';
        testinfo += 'Unterst\xfctztes Dorf:\n';
      ...
      gesamtzeile += 'Gesamtzahl der unterst\xfctzenden Truppen:&ensp;';
      ...
      gesamtzeile += '<th>Zur\xfcckrufen</th>';
      gesamtzeile += '</tr>';
      ...
      info += '<td style=\'background-color:#F7EED3;\'>Momentan sind keine ausw\xe4rtigen Truppen gespeichert</td>';
      info += '</tr>';
      // Infotabelle schliessen:
      info += '<tr>';
      info += '<td colspan=\'2\'>';
  ...
  if (url.match(/screen=overview_villages*/)) {
    ...
    if (pa_info > 0) {
      ...
      if (tabelle.getElementsByTagName('tr')[0].getElementsByTagName('th')[0].innerHTML == 'D\xf6rfer Welt-' + welt) {
      ...
      tabelle.getElementsByTagName('tr')[0].innerHTML += '<th style=\'width:25px; -moz-border-radius-topleft:10px; -moz-border-radius-topright:10px;\'><img src=\'http://www.die-staemme.de/graphic/command/support.png\' title=\'Anzahl der unterst\xfctzten D\xf6rfer\'></th>';
      // Dörferliste:
      var dorfliste = GM_getValue('W' + welt + '-Dorfliste');
      var dorfnamen = '';
      ...
      for (var i = 1; i <= zeilen; i++) {
        ...
        if (GM_getValue('W' + welt + '-Info-' + akt_id) != undefined) {
          ...
          infotabelle += '<tr><td>\xfcber Deine ausw\xe4rtigen Truppen gespeichert.</td></tr>';
      ...
      if (tabelle.getElementsByTagName('tr')[0].getElementsByTagName('th')[0].innerHTML.indexOf('D\xf6rfer Welt-' + welt) > -1) {
        tabelle.getElementsByTagName('tr')[zeilen + 1].innerHTML += '<th title=\'Gesamtzahl aller Unterst\xfctzungen\' style=\'cursor:help; -moz-border-radius-bottomleft:10px; -moz-border-radius-bottomright:10px;\'>' + gesamt + '</th>';
      }
      // Werte als GM-Value speichern:
  ...
  if (url.match(/screen=info_village/)) {
    ...
    if (dorfliste == undefined) {
      ...
      tab2 += '</tr>';
      tab2 += '<tr>';
      tab2 += '<td>Die Liste Deiner D\xf6rfer wurde noch nicht gespeichert.</td>';
      tab2 += '</tr>';
      tab2 += '<tr>';
      tab2 += '<td>Zum speichern der Liste einfach die <a href=\'http://' + land + welt + adresse[land] + land + '/game.php?village=' + akt_dorf_id + '&screen=overview_villages&mode=combined\'>D\xf6rfer\xfcbersicht</a> aufrufen.</td>';
      tab2 += '</tr>';
      ...
      for (var d = 0; d < dorf.length; d++) {
        ...
        if (dorf_info.indexOf(dorf_id) > -1) {
          ...
          for (var z = 1; z < infozeile.length; z++) {
            // 
            if (infozeile[z].indexOf(dorf_id) > -1 && infozeile[z].indexOf(dorf_name) > -1) {
              count++;
      ...
      if (count == 0) {
        tab2 += '<tr>';
        tab2 += '<td colspan=\'' + cols + '\'>Momentan wird dieses Dorf nicht von Dir unterst\xfctzt.</td>';
    ...
    truppen_gesamt += '<th colspan=\'' + cols + '\' style=\'text-align:left; -moz-border-radius-bottomleft:10px; -moz-border-radius-bottomright:10px;\'>&ensp;Gesamtzahl der unterst\xfctzenden Truppen:&ensp;';
  ...
  //										//
  //**************************************//
  if (url.match(/screen=map/) && GM_getValue('Kartenmarkierungen-' + welt) == 'an') {
    // Stammes-ID:
    var stamm_id = url.split('id=')[1];
    // Dorfliste;
    ...
    for (var y = 0; y < zeilen; y++) {
      ...
      for (var x = 0; x < spalten; x++) {
        ...
        if (links > 0) {
          ...
          if (supp == 1) {
            var support = 'Dorf wird unterst\xfctzt';
            ...
            var support = 'Keine Unterst\xfctzung';
          }
          // Testinfo erweitern:
          testinfo += 'Zelle ' + y + '/' + x + ':\n';
          testinfo += dorf_name + '\n';
